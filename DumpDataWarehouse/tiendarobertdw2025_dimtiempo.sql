...
CREATE TABLE `dimtiempo` (
  ...
  `nombreMes` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `semanaAnio` tinyint NOT NULL,
  `dia` tinyint NOT NULL,
  `nombreDia` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `esFinDeSemana` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `diaJuliano` smallint NOT NULL,
  PRIMARY KEY (`tiempoKey`)
) ENGINE=InnoDB AUTO_INCREMENT=29322 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
