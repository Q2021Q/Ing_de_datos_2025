...
CREATE TABLE `compras_detalles` (
  ...
  PRIMARY KEY (`id`),
  KEY `compras_detalles_compra_foreign` (`compra`),
  KEY `compras_detalles_producto_foreign` (`producto`),
  KEY `compras_detalles_medida_foreign` (`medida`),
  CONSTRAINT `compras_detalles_compra_foreign` FOREIGN KEY (`compra`) REFERENCES `compras` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `compras_detalles_medida_foreign` FOREIGN KEY (`medida`) REFERENCES `medidas` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `compras_detalles_producto_foreign` FOREIGN KEY (`producto`) REFERENCES `productos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
