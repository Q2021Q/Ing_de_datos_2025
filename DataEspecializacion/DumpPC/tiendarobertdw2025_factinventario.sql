...
--
-- Dumping data for table `factinventario`
--

LOCK TABLES `factinventario` WRITE;
/*!40000 ALTER TABLE `factinventario` DISABLE KEYS */;
/*!40000 ALTER TABLE `factinventario` ENABLE KEYS */;
UNLOCK TABLES;
