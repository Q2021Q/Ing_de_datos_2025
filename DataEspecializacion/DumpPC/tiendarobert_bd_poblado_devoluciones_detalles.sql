...
CREATE TABLE `devoluciones_detalles` (
  ...
  PRIMARY KEY (`id`),
  KEY `devoluciones_detalles_devolucion_foreign` (`devolucion`),
  KEY `devoluciones_detalles_producto_foreign` (`producto`),
  KEY `devoluciones_detalles_medida_foreign` (`medida`),
  CONSTRAINT `devoluciones_detalles_devolucion_foreign` FOREIGN KEY (`devolucion`) REFERENCES `devoluciones` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `devoluciones_detalles_medida_foreign` FOREIGN KEY (`medida`) REFERENCES `medidas` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `devoluciones_detalles_producto_foreign` FOREIGN KEY (`producto`) REFERENCES `productos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2025-10-28 21:21:56
