...
CREATE TABLE `ajustes` (
  ...
  PRIMARY KEY (`id`),
  KEY `ajustes_sucursal_foreign` (`sucursal`),
  CONSTRAINT `ajustes_sucursal_foreign` FOREIGN KEY (`sucursal`) REFERENCES `sucursales` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
