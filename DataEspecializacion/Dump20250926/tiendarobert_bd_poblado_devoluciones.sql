...
CREATE TABLE `devoluciones` (
  ...
  PRIMARY KEY (`id`),
  KEY `devoluciones_sucursal_foreign` (`sucursal`),
  KEY `devoluciones_empresa_foreign` (`empresa`),
  KEY `devoluciones_venta_foreign` (`venta`),
  CONSTRAINT `devoluciones_empresa_foreign` FOREIGN KEY (`empresa`) REFERENCES `empresas` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `devoluciones_sucursal_foreign` FOREIGN KEY (`sucursal`) REFERENCES `sucursales` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `devoluciones_venta_foreign` FOREIGN KEY (`venta`) REFERENCES `ventas` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2025-09-26  7:51:03
